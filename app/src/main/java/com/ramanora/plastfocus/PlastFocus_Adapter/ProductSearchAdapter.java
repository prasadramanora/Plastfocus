...
public class ProductSearchAdapter extends RecyclerView.Adapter<ProductSearchAdapter.DataHolder> implements Filterable {
    ...
    public ProductSearchAdapter(Context mContext, ArrayList<PlastFocusModelClass> mArrayListCompany) {
    ...
    @Override
    public ProductSearchAdapter.DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater= LayoutInflater.from(mContext);
        View view=inflater.inflate(R.layout.country_company_adapter,parent,false);

        ProductSearchAdapter.DataHolder dataHolder=new ProductSearchAdapter.DataHolder(view);
        return dataHolder;
    }

    @Override
    public void onBindViewHolder(final ProductSearchAdapter.DataHolder holder, @SuppressLint("RecyclerView") final int position) {
