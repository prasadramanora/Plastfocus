...
import com.ramanora.plastfocus.PlastFocus_Activities.ActivityImageMapping;
...
public class ExhibitorMapAdapter extends RecyclerView.Adapter<ExhibitorMapAdapter.DataHolder> implements Filterable, Serializable {
    ...
    public ExhibitorMapAdapter(Context mContext, List<PlastFocusModelClass> ExhibitorAtoZList, OnItemClickListener listener) {
    ...
    @Override
    public ExhibitorMapAdapter.DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.exhibitor_az_adapter, parent, false);
        ExhibitorMapAdapter.DataHolder dataHolder = new ExhibitorMapAdapter.DataHolder(view);
        return dataHolder;
    }

    @Override
    public void onBindViewHolder(final ExhibitorMapAdapter.DataHolder holder, @SuppressLint("RecyclerView") int position) {
...
//        Log.e("getY()",azExhibitorListPojo.getY());
      ...
      /*  holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent( mContext, ActivityImageMapping.class);
