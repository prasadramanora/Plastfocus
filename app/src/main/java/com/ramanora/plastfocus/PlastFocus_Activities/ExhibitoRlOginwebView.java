...
public class ExhibitoRlOginwebView  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(ExhibitoRlOginwebView.this, R.style.StyledDialog);
        ...
        mwebviewvirtualexhibition.loadUrl(ActivityMainHomePage.webviewlink);
        ...
        mwebviewvirtualexhibition.setWebViewClient(new ExhibitoRlOginwebView.CustomWebViewClient());
